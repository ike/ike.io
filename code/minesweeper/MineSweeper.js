...
jQuery(function ($) {
    ...
    MineSweeper = function () {
        ...
        self.defaults = {
            ...
            board_size: [9, 9],
            num_mines: 10,
            path_to_cell_toucher: 'cell_toucher.js'
        };
        self.RIGHT_MOUSE_CLICKED = false;
        self.sounds = {
            new_game: new Audio("sounds/new_game.wav"),
            select: new Audio("sounds/select.wav"),
            explosion: new Audio("sounds/explosion.wav"),
            winning: new Audio("sounds/winning.mp3")
        };
        ...
        this.initHandlers = function () {
            ...
            $('.new-game').click(function (ev) {
                ...
                // Stop winning
                self.sounds.winning.pause();
                self.sounds.winning.currentTime = 0;
                $('.won_alert').css('display', 'none');
        ...
        this.clearBoard = function () {
            var width = self.options.board_size[0],
                ...
                map = self.maps.getRandomMap().src;
        ...
        this.drawCell = function (x, y) {
            ...
            switch (gridobj.state) {
                case STATE_FLAGGED:
                    cell.addClass('icon flag');
                    cell.addClass(gridobj.state);
                    break;
                case STATE_QUESTION:
                    cell.addClass('icon help');
                    cell.addClass(gridobj.state);
                    break;
                case STATE_UNKNOWN:
                case STATE_OPEN:
        ...
        this.winGame = function () {
            self.running = false;
            self.sounds.winning.currentTime = 3;
            self.sounds.winning.play();
            $('.won_alert').css('display', 'block');
        };
